...
<div class="d-flex gap-2 mb-4 flex-wrap">
    @foreach([''=>'Tất cả','pending'=>'Chờ xác nhận','confirmed'=>'Đã xác nhận','delivering'=>'Đang giao','completed'=>'Hoàn thành','cancelled'=>'Đã hủy'] as $val => $label)
    ...
    <div class="card-body p-0">
        <table class="table table-hover mb-0">
            ...
            <tr>
                ...
                <td><span class="badge bg-{{ $colors[$order->status] ?? 'secondary' }}">{{ $order->status }}</span></td>
